...
import { MoreVertical, Share, Star } from 'lucide-react'
import ProjectAction from './_components/projects-actions'
  ...
  return (
    <div className='px-4 md:px-24 pt-28'>
      ...
      <div className='mt-8 flex flex-col md:flex-row-reverse gap-6 md:mx-12 lg:mx-24'>
        ...
        <iframe
          src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d191885.5985383025!2d${data[0]?.lon}!3d${data[0]?.lat}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38ae8b0cc379e9c3%3A0xa5a9323b4aa5cb98!2sTashkent%2C%20Uzbekistan!5e0!3m2!1sen!2s!4v1756131178554!5m2!1sen!2s`}
          loading='lazy'
